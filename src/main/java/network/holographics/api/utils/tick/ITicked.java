package network.holographics.api.utils.tick;
 ...
 * can be registered to HolographicsAPI ticker. This ticker will call the tick() method every
...
public interface ITicked {
    ...
    default void register() {
        HolographicsInternalAPI.get().getTicker().register(this);
    }
    ...
    default void unregister() {
        HolographicsInternalAPI.get().getTicker().unregister(getId());
    }
